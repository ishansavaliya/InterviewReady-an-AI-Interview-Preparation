 ...
 * The landing page of the application showcasing the main features
 * and value proposition of InterviewReady
 */
...
/**
 * HomePage Component
 * Renders the main landing page with hero section, statistics,
